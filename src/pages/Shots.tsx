...
function SecurityScreen() {
  const rows = [
    { i: "Lock", t: "Сквозное шифрование", s: "Защита для всех чатов", on: true },
    { i: "KeyRound", t: "Двухфакторный вход", s: "Дополнительный код", on: true },
    { i: "Fingerprint", t: "Вход по отпечатку", s: "Быстро и безопасно", on: true },
    { i: "EyeOff", t: "Скрывать текст", s: "В уведомлениях на экране", on: true },
    { i: "Timer", t: "Исчезающие сообщения", s: "Удаляются автоматически", on: false },
