  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="flex-1 overflow-y-auto p-4 text-sm leading-relaxed space-y-5">
        <section>
          <h2 className="text-base font-semibold mb-1">Nova — мессенджер для общения</h2>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-1 ml-1">
            <li>Номер телефона, имя и пароль (регистрация и вход; пароль хранится только в зашифрованном виде)</li>
        ...
        <section>
          ...
          <p>
            Сервис предназначен для лиц старше 18 лет. Регистрируясь, вы
        ...
        <section>
          ...
          <p>
            Оператор персональных данных: Шашаев Максим Алексеевич,
            самозанятый (плательщик налога на профессиональный доход),
            ИНН 524925378506, Нижегородская область, Российская Федерация.
          </p>
          <p className="mt-2">
