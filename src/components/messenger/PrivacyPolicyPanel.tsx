      ...
      <div className="flex-1 overflow-y-auto p-4 text-sm leading-relaxed space-y-5">
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-1 ml-1">
            <li>Номер мобильного телефона (регистрация и вход по SMS)</li>
            <li>Имя, фамилия, аватар, «О себе», пол, дата рождения (по желанию)</li>
        ...
        <section>
          ...
          <p>
            ...
            устройства без содержимого сообщений; SMS-провайдеру — номер для кода
            подтверждения; уполномоченным госорганам — по законным запросам.
          </p>
        </section>
